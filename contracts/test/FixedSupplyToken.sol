...
// ----------------------------------------------------------------------------
// BokkyPooBah's Fixed Supply Token for testing
//
// https://github.com/bokkypoobah/AucrionFactory
//
...
contract FixedSupplyToken is TokenInterface, Owned {
    ...
    constructor(string memory symbol, string memory name, uint8 decimals, uint fixedSupply) public {
